...
public class CompareEditorSelectionProvider implements IPostSelectionProvider {
     ...
     * @since 3.6
     */
    // private static boolean isSelectionInsideVisibleRegion(TextViewer textViewer, ISelection
    // selection) {
    ...
    // return textSelection.getOffset() >= visibleRegion.getOffset() && textSelection.getOffset() +
    // textSelection.getLength() <= visibleRegion.getOffset() + visibleRegion.getLength();
    // }
