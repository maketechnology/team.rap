...
abstract public class DetailsDialog extends TrayDialog {
	...
	protected String getDetailsButtonLabelShow() {
        return IDialogConstants.get().SHOW_DETAILS_LABEL;
	}

	protected String getDetailsButtonLabelHide() {
        return IDialogConstants.get().HIDE_DETAILS_LABEL;
	}
    ...
    /**
     * Return the help context id to be used for the dialog. This context Id will be registered by
     * this class. By default, this method returns <code>null</code>.
     * 
    ...
    /**
     * Return whether the main area should grab excess vertical space. The default is
     * <code>true</code> but subclasses can override in cases where the main is more or less fixed
     * but the details needs to grab.
     * 
