...
public class MultipleYesNoPrompter {
	...
	public MultipleYesNoPrompter(IShellProvider provider, String title, boolean hasMultiple, boolean allOrNothing) {
		...
		if (hasMultiple) {
			if (allOrNothing) {
				buttons = new String[] {
                                IDialogConstants.get().YES_LABEL, IDialogConstants.get().YES_TO_ALL_LABEL, IDialogConstants.get().CANCEL_LABEL};
			} else {
				buttons = new String[] {
                                IDialogConstants.get().YES_LABEL, IDialogConstants.get().YES_TO_ALL_LABEL, IDialogConstants.get().NO_LABEL, IDialogConstants.get().NO_TO_ALL_LABEL, IDialogConstants.get().CANCEL_LABEL};
			}
		} else {
			buttons = new String[] {
