...
class CopyToClipboardAction extends SelectionListenerAction {
    ...
    /*
     * Return a text representation of all selected elements. Use the name from the tree node so
     * what is copied matches what appears in the tree.
     */
    ...
    private void setClipboard(IResource[] resources, String[] fileNames, String names) {
        try {
            ...
            if (!data.isEmpty())
                fClipboard.setContents(data.toArray(), (Transfer[]) dataTypes.toArray(new Transfer[dataTypes.size()]));
        } catch (SWTError e) {
