...
public abstract class SynchronizeModelAction extends BaseSelectionListenerAction {
    ...
    /**
     * Create and run the operation for this action. By default, the operation is created by calling
     * <code>getSubscriberOperation</code> and then run. Subclasses may override.
     *
